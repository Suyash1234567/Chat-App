...
export class UserService {
    ...
    ShowAllMessagesFromChannel(channelId): Observable<any> {        //corresponding to a channel id
        return this.http.get('https://chat.twilio.com/v2/Services/IS428c9c766b8b412abc1d0545f6019e59/Channels/'+channelId+'/Messages', this.httpOptions);
    }

    SendMessageToChannel(str,channelId): Observable<any> {      //Str is the message sent corresponding to a particular channelId
        return this.http.post('https://chat.twilio.com/v2/Services/IS428c9c766b8b412abc1d0545f6019e59/Channels/'+channelId+'/Messages', 'ChannelSid='+channelId+'&ServiceSid=IS428c9c766b8b412abc1d0545f6019e59&From=' + this.User.email + '&Body=' + str, this.httpOptions);
    }
